...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?=$base;?>/assets/site/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?=$base;?>/assets/site/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?=$base;?>/assets/site/css/owl.carousel.css">
    <link rel="stylesheet" href="<?=$base;?>/assets/site/css/style.css">
    <link rel="stylesheet" href="<?=$base;?>/assets/site/css/responsive.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="<?=$base;?>/profile"><i class="fa fa-user"></i> Minha Conta</a></li>
                            ...
                            <?php if($loggedUser): ?>
                                <li><a href="<?=$base;?>/profile"><i class="fa fa-user"></i><?=$loggedUser->desperson;?></a></li>
                                <li><a href="<?=$base;?>/logout"><i class="fa fa-close"></i> sair </a></li>
                            <?php else: ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="<?=$base;?>/cart">Carrinho - <span class="cart-amunt">R$ <?=$total_cart?></span> <i class="fa fa-shopping-cart"></i> <span class="product-count"><?=$qtd_itens?></span></a>
                    </div>
                </div>
            </div>
        </div>
