<div class="footer-top-area">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <?php $render('site/categories-menu');?>
                        </ul>                        
                    </div>
                </div>
    ...
    <script src="<?=$base;?>/assets/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="<?=$base;?>/assets/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="<?=$base;?>/assets/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="<?=$base;?>/assets/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="<?=$base;?>/assets/site/js/script.slider.js"></script>
  </body>
</html>