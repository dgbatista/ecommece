<div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="<?=$base;?>/public/assets/site/js/owl.carousel.min.js"></script>
    <script src="<?=$base;?>/public/assets/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="<?=$base;?>/public/assets/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="<?=$base;?>/public/assets/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="<?=$base;?>/public/assets/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="<?=$base;?>/public/assets/site/js/script.slider.js"></script>
  </body>
</html>