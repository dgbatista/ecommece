                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            ...
                            <h2><a href=""><?=$product->desproduct;?></a></h2>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-price">
                                        <ins>R$<?=$product->vlprice;?></ins>
                                    </div>    
                                    
                                    <form action="<?=$base;?>/cart/<?=$product->idproduct;?>/add" class="cart">
                                        <div class="quantity">
                                    ...
                                    <div class="product-inner-category">
                                        <p>Category:
                                            <?php foreach($categories as $categorie):?>
                                                <a href="<?=$base;?>/categories/<?=$categorie['idcategory']?>"><?=$categorie['descategory']?></a>
                                            <?php endforeach?>
                                    </div> 
