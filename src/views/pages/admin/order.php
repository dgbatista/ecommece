    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="<?=$base;?>/assets/site/img/logo.png" alt="Logo">
        ...
        <div class="row invoice-info">
            ...
            <address>
                ...
                <?=($order->nrphone && $order->nrphone != '0') ? 'Telefone: '.$order->nrphone .'<br>': ''?>
                <?=($order->desemail && $order->desemail != '0') ? 'E-mail: '.$order->desemail .'<br>': ''?>
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
            ...
            <br>
            <b>Emitido em:</b> <?=date('d/m/Y H:i:s',strtotime($order->dtregister));?><br>
            <b>Pago em:</b> <?=date('d/m/Y H:i:s',strtotime($order->dtregister));?><br>
            </div>
            <!-- /.col -->
        </div>
        <!-- /.row -->
